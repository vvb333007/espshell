...
Это инструмент для отладки и разработки (библиотека для фреймворка Arduino), предназначенный для использования с **ESP32** (работает на разных вариантах процессора: ESP32, ESP32S3, ESP32C6 и ESP32P4).
